...
(defun color-theme-twilight ()
  ...
  (color-theme-install
   '(color-theme-twilight
     ...
     (font-lock-builtin-face ((t (:foreground "#bbb"))))
     (font-lock-comment-face ((t (:italic t :foreground "#ffb412"))))
     (font-lock-constant-face ((t (:foreground "#CF6A4C"))))
     (font-lock-doc-string-face ((t (:foreground "DarkOrange"))))
     (font-lock-function-name-face ((t (:foreground "#fff950"))))
     (font-lock-keyword-face ((t (:bold t :foreground "#5cd075"))))
     (font-lock-preprocessor-face ((t (:bold t :foreground "#a87dc8"))))
     (font-lock-reference-face ((t (:foreground "SlateBlue"))))

     (font-lock-regexp-grouping-backslash ((t (:foreground "#E9C062"))))
     (font-lock-regexp-grouping-construct ((t (:foreground "red"))))

     (font-lock-string-face ((t (:foreground "#ff4e25"))))
     (font-lock-type-face ((t (:bold t :foreground "#637cd9"))))
